            ...
            <Card>
                {
                    userProfile !== "" && userProfile.success === true ?
                        <div>
                            ...
                            <Link to="/user/posts"><h3><b>CreatePosts: </b></h3></Link>
                        {/* Nếu muốn tránh bị lặp đường dẫn (ví dú http://localhost:4000/user/user/posts thì dùng dấu gạch trước đường dẫn, còn nếu để user/posts sẽ bị lặp đường dẫn*/}
                        </div>
                        :
